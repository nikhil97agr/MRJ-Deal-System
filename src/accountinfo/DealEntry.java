...
public class DealEntry extends javax.swing.JFrame {
    ...
    */
    ...
    private void initComponents() {
        ...
        brokerTdsPercent = new javax.swing.JTextField();
        ...
        jLabel1.setText("BROKER TDS RATE");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 240, 120, 30));

        brokerTdsPercent.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        brokerTdsPercent.setText("5");
        jPanel1.add(brokerTdsPercent, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 240, 40, 30));
    ...
    */
    ...
    private javax.swing.JTextField brokerTdsPercent;
    ...
    private void updateUI(DealData data) throws IOException {
        ...
        fromDateInput.setDate(new Date(data.getToDate()));
        Calendar cal = Calendar.getInstance();
        cal.setTime(fromDateInput.getDate());
        cal.add(Calendar.MONTH, 3);
        toDateInput.setDate(cal.getTime());
    ...
    private void addListener() {
        ...
        brokerTdsPercent.getDocument().addDocumentListener(new DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                String prevValue = brokerInterestInput.getText();
                try{
                    
                    double interest = Float.valueOf(brokerInterestInput.getText());
                    double tdsRate = Float.valueOf(brokerTdsPercent.getText());
                    
                    double tds = (interest*tdsRate)/100f;
                    double net = interest - tds;
                    brokerTdsInput.setText(""+Math.round(tds));
                    brokerNetInput.setText(""+Math.round(net));
                }catch(Exception ex)
                {
                    brokerInterestInput.setText(prevValue);
                }
...
//                Desktop.getDesktop().open(new File("C:\\Users\\Lenovo\\Desktop\\abc.pdf"));
    ...
    private void calculateBrokerInterest() {
        ...
        if (!brokerTdsPercent.getText().isEmpty() && isDigit(brokerTdsPercent.getText())) {
            brokerTdsRate =  Float.valueOf(brokerTdsPercent.getText());
        }
        
        interest1 = (amount1 * rate1 * duration) / 100f;
        brokerInterestInput.setText("" + Math.round(interest1));
        
        tds1 = (interest1 * brokerTdsRate) / 100f;
        brokerTdsInput.setText("" + Math.round(tds1));
        net1 = interest1 - tds1;
        brokerNetInput.setText("" + Math.round(net1));
    }
